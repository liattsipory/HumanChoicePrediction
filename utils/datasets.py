        ...
        def __init__(self, user_improve, basic_nature, favorite_topic_method, **args):
            ...
            self.ACTIONS = {0: ("correct - oracle", 0, user_strategies.correct_action),
                            ...
                            3: ("topic based", basic_nature[2], user_strategies.topic_based(positive_topics,
                                                                                            negative_topics,
                                                                                            quality_threshold)),
                            4: ("LLM_static",  basic_nature[3], user_strategies.LLM_based(is_stochastic=True)),
                            5: ("LLM_dynamic", basic_nature[4], user_strategies.LLM_based(is_stochastic=False)),
                            ...
                            11: ("HRQ_plus_LLM_plus_random_simultanly", basic_nature[10], user_strategies.HRQ_plus_LLM_plus_random_simultanly(history_window, quality_threshold)),
                            }
